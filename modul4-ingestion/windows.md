...
Ini membaca file `.txt` di `sample_docs/`, memecahnya jadi chunk, membuat embedding lewat Gemini API, dan menyimpannya ke tabel `documents`. Aman dijalankan berkali-kali (idempotent).
