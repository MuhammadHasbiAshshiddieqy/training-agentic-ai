...
Modul 7 & 8 membawa maju teknik retrieval dari Modul 5 & 6 alih-alih
kembali ke vector search polos ala Modul 4 — supaya endpoint /search DAN
tool cari_dokumen (dipakai Gemini lewat function calling) sama-sama
memakai kualitas retrieval yang sama. Dipisah ke modul sendiri (bukan
ditaruh di main.py atau tools.py) supaya keduanya bisa saling
mengimpornya tanpa circular import (main.py mengimpor tools.py, jadi
tools.py tidak bisa balik mengimpor dari main.py).
