"""
Modul 9 - Pipeline Data Ingestion + Hybrid Search Index (dibawa maju dari Modul 8)
AI Knowledge Assistant - Human Initiative

Tidak ada perubahan logika ingestion di modul ini dibanding Modul 8 - yang
baru ada di cache.py (embedding cache) dan main.py/tools.py (yang memakainya
lewat embed_text_cached). embed_text() di sini tetap dipakai APA ADANYA oleh
ingest.py sendiri (proses ingestion nge-embed tiap chunk dokumen SEKALI saja
saat data dimasukkan, jadi caching di sini tidak relevan - yang berulang dan
layak di-cache adalah QUERY pencarian, bukan isi dokumen).
