...
## 5. Coba tool calling lewat /chat
...
Response menampilkan `answer` (jawaban akhir) dan `tools_called` (tool apa
saja yang benar-benar dipanggil Gemini, dengan argumen dan hasilnya).
